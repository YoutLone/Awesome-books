...
> The awesome books project is create to add and removed your favourite book.
...
- User can add favourite book
- User can remove unlike book
- Books data are stored in localStorage
...
```
git clone https://github.com/YoutLone/Awesome-books.git
```
...
Feel free to check the [issues page](https://github.com/YoutLone/Awesome-books/issues).
